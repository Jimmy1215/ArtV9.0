...
public class CourseBeanServiceFront {

	private CourseBeanDAOFront cDAOF;

	public CourseBeanServiceFront() {

	}

	@Autowired
	public CourseBeanServiceFront(CourseBeanDAOFront cDAOF) {
		this.cDAOF = cDAOF;
	}
